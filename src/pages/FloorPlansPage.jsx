...
const FloorPlansPage = () => {
  ...
  return (
    <main className="bg-[#F6F4EF] min-h-screen pb-24">
      <PageHero 
        title="Floor Plans." 
        subtitle="Architectural Layouts"
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20 max-w-[1440px] mx-auto">
        <div className="max-w-4xl mb-24">
          <Reveal>
            ...
            <h2 className="font-serif text-5xl md:text-7xl leading-[1.1] text-neutral-800">
              Detailed layouts for <br />
              <span className="italic text-stone-400 font-light">visionary living.</span>
            </h2>
          </Reveal>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-48 gap-4 text-neutral-400">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.3em]">Loading layouts...</span>
          </div>
        ) : plans.length > 0 ? (
