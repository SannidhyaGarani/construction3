      ...
      <section className="relative h-[80vh] w-full overflow-hidden bg-[#0A192F] text-white">
        ...
        <div className="relative z-20 max-w-[1440px] mx-auto w-full h-full px-6 md:px-12 lg:px-20 flex flex-col justify-center">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl tracking-tight leading-[0.9] mb-6">
            Signature <span className="italic font-light text-white/90">Engineering Insights</span> <br />
            For the <span className="text-[#D4AF37] font-serif">Modern Age</span>.
          </h1>
          <p className="text-sm md:text-base text-white/70 font-light max-w-xl">
            Our blogs provide expert insights into civil engineering, architectural design, and industry trends.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20 max-w-[1440px] mx-auto">
        <div className="mb-16">
          <Reveal>
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl leading-[1.1] tracking-tight text-[#0A192F]">
              Explore Our <span className="italic text-[#D4AF37] font-light">Latest Articles</span>
            </h2>
          </Reveal>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-48 gap-4 text-neutral-400">
            ...
            <span className="text-[10px] uppercase tracking-[0.3em] font-bold">Loading articles...</span>
          </div>
        ) : blogs.length > 0 ? (
                ...
                >
                  <div className="relative bg-white border border-neutral-300 overflow-hidden transition-all duration-500 hover:shadow-xl hover:border-[#D4AF37]/50">
                    ...
                    <div className="relative aspect-[16/10] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 backdrop-blur-sm bg-[#0A192F]/70 border border-white/20 px-3 py-1 text-[9px] tracking-[0.3em] uppercase text-white">
                        Article
                      </div>
                    ...
                    <div className="p-5 flex flex-col gap-4">
                      <div>
                        <h3 className="text-[10px] font-semibold tracking-[0.25em] uppercase text-[#0A192F] leading-tight">
                          {blog.title}
                        </h3>
                        <div className="flex items-center gap-3 mt-2">
                          <span className="h-[1px] w-5 bg-[#D4AF37]" />
                          <p className="text-[9px] uppercase text-neutral-600 tracking-[0.2em]">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-neutral-200">
                        <div className="flex flex-col">
                          <span className="text-[8px] uppercase text-neutral-500 tracking-widest">
                            Category
                          </span>
                          <span className="text-[11px] font-semibold text-[#0A192F] tracking-wide">
                            Insights
                          </span>
                        </div>
          ...
          <div className="flex flex-col items-center justify-center py-48 text-center bg-white border border-dashed border-neutral-300">
            <BookOpen className="text-neutral-400 mb-6" size={64} />
            <h3 className="text-2xl font-serif text-neutral-700">No articles published yet</h3>
          </div>
        )}
      </section>
