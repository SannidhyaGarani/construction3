      ...
      <section className="relative h-[80vh] w-full overflow-hidden bg-[#0A192F] text-white">
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{ backgroundImage: `url('https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=2000&auto=format&fit=crop')` }}
          />
        ...
        <div className="relative z-20 max-w-[1440px] mx-auto w-full h-full px-6 md:px-12 lg:px-20 flex flex-col justify-center">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl tracking-tight leading-[0.9] mb-6">
            Signature <span className="italic font-light text-white/90">Interior Designs</span> <br />
            That Define <span className="text-[#D4AF37] font-serif">Luxury</span>.
          </h1>
          <p className="text-base md:text-lg text-white/70 font-light max-w-xl">
            Curated interior concepts that blend contemporary aesthetics with timeless design principles.
          </p>
        </div>
      </section>

      {/* INTERIORS GRID SECTION */}
      <section className="py-24 px-6 md:px-12 lg:px-20 max-w-[1440px] mx-auto">
        <div className="mb-16">
          <Reveal>
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl leading-[1.1] tracking-tight text-[#0A192F]">
              Explore Our <span className="italic text-[#D4AF37] font-light">Interior Collection</span>
            </h2>
          </Reveal>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-48 gap-4 text-neutral-600">
            ...
            <span className="text-xs uppercase tracking-[0.3em] font-bold">Loading interiors...</span>
          </div>
        ) : interiors.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-48 text-center bg-white border border-dashed border-neutral-300">
            <Sofa className="text-neutral-400 mb-6" size={64} />
            <h3 className="text-2xl font-serif text-neutral-700">No interior designs found</h3>
          </div>
        )}
      </section>
