...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#C5A880]/10 rounded-full blur-[120px]"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#C5A880]/5 rounded-full blur-[120px]"></div>
        ...
        <div className="bg-[#0B0F14]/80 backdrop-blur-xl border border-white/5 rounded-[40px] p-10 md:p-12 shadow-2xl relative z-10">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            <div className="w-16 h-16 bg-[#C5A880] rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-[#C5A880]/20">
              <LogIn className="text-[#050505]" size={32} />
            </div>
            <h1 className="font-serif text-3xl text-white uppercase tracking-tight mb-2">Archelon</h1>
            <span className="text-[10px] uppercase tracking-[0.5em] text-[#C5A880] font-bold italic">Admin Login</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-neutral-500 ml-2">Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
          ...
          {/* <div className="mt-10 text-center">
            <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 font-bold">
              New Admin? <Link to="/admin/signup" className="text-[#C5A880] hover:underline hover:underline-offset-4 ml-1 transition-all">Sign Up here</Link>
            </p>
          </div> */}
        </div>
